...
export function MindMapNode({
  ...
  return (
    <g style={{ opacity: isDragging ? 0.4 : 1 }}>
      {/* 节点矩形 */}
      <foreignObject
        x={x - displayWidth / 2}
        y={y - displayHeight / 2}
        ...
        >
          {isEditing ? (
            ...
            <textarea
              ...
              className={`w-full ${bgColor} ${textColor} px-3 py-2 rounded outline-none text-sm resize-none border-0`}
              style={{
                lineHeight: "22px",
                ...
                backgroundColor: "transparent", // 使用父容器的背景色
              }}
